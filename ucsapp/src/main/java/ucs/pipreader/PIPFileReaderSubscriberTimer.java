...
final class PIPFileReaderSubscriberTimer extends TimerTask {
    ...
    PIPFileReaderSubscriberTimer(PIPFileReader pip ) {
    ...
    public void start() { timer.scheduleAtFixedRate( this, 0, rate ); }
