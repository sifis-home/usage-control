...
/**
 * This is the result sent by the PDP The result of an evaluation is composed by
 * a ResponseType that is one of those classes generated by the XJC tool
 * starting from the xsd of the XACML definition. Furthermore we have an
 * attribute that signals the id of the session to which the evaluation is
 * referred to and a boolean that states if the object is in a correct state
 *
