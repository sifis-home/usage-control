...
public interface ContextHandlerInterface extends ContextHandlerAttributeUpdateInterface {
	...
	/**
	 * This is the tryAccess function. In this case the RequestManager passes to the
	 * ContextHandler a message in which it has been specified the request received,
	 * the policy to be used and the uri of the PEP. It will also send eventual
	 * Obligations provided by the ObligationManager
	 *
	 * @param message message received by the RequestManager
	 ...
	 * can go on, moreover this triggers the contiunous monitoring of the attributes
	 * of the policy.
	 *
	 * @param message message received by the RequestManager
	 * @return a message stating the response of the PDP to the request
	 ...
	 * resource anymore or the access to the resource has been denied, hence the PEP
	 * notifies the CH to stop monitoring that session. The CH answers by sending to
	 * the PEP the response to the ENDAccess. It will be the ObligationManager in
	 * charge of
	 *
	 * @param message the message received by the RequestManager
	 * @return a message stating the response of the PDP to the request
	 * @throws StatusException
	 * @throws RequestException
	 * @throws PolicyException
