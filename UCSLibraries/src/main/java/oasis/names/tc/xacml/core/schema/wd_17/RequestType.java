...
public final class RequestType {
	...
	/**
	 * Retrieves the first attribute value stored inside the request attributes. By
	 * assumption in our case in the original request we have just the attributes
	 * related to the name of the subject who performs the action, the name of the
	 * action he wants to perform and the name of the resource on which he wants to
...
//		}
	...
	public String getAttribute(String category, String attributeId) {
		...
		if (attbs != null) {
			AttributeType attr = attbs.getAttribute().stream().filter(a -> a.getAttributeId().endsWith(attributeId))
	...
	public boolean addAttribute(Attribute attribute, String value) {
		return addAttribute(attribute.getCategory().toString(), attribute.getDataType().toString(),
				attribute.getAttributeId(), value);
	}

	public boolean addAttribute(String category, String dataType, String attributeId, String value) {
	...
	public boolean addAttribute(String category, String dataType, String attributeId, List<String> value) {
		AttributeValueType attributeValueType = new AttributeValueType();
		attributeValueType.setDataType(dataType);
