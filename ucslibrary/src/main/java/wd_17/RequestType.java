...
public final class RequestType {
    ...
    public boolean addAttribute(xacml.Attribute attribute, String value ) {
...
//        log.info("AddAttribute for category: " + category + ", value: " + value + ", dataType: " + dataType);
        AttributeValueType attributeValueType = new AttributeValueType();
        attributeValueType.setDataType( dataType );
        attributeValueType.setContent( value );
