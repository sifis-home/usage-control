...
@Root( name = "ObligationExpressionType" )
public class ObligationExpressionType {

    @ElementList( name = "AttributeAssignmentExpression" )
    protected List<AttributeAssignmentExpressionType> attributeAssignmentExpression;
    @Attribute( name = "ObligationId", required = true )
    // @XmlSchemaType(name = "anyURI")
    protected String obligationId;
    @Attribute( name = "FulfillOn", required = true )
