...
public class OnGoingAttribute implements OnGoingAttributesInterface {
	...
	@DatabaseField(foreign = true, foreignAutoRefresh = true, canBeNull = false, columnName = SESSION_ID_FIELD_NAME)
	...
	private OnGoingAttribute(String attributeId, String subjectName, String resourceName, String actionName) {
	...
	public static OnGoingAttribute createOnGoingAttributeForResource(String attributeId, String resourceName) {
		...
		return new OnGoingAttribute(attributeId, null, resourceName, null);
	}
